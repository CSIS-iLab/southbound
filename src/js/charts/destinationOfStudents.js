...
const destinationOfStudents = () => {
  Highcharts.chart('destinationofstudents', {
    ...
    title: {
      text: 'Study Abroad Destination of Outbound Students From Taiwan, 2015-2016'
    },
    // Credits
    credits: {
      enabled: true,
      href: 'https://depart.moe.edu.tw/ed2500/News_Content.aspx?n=2D25F01E87D6EE17&sms=4061A6357922F45A&s=ECAAD5FFD81C8057',
      text:
